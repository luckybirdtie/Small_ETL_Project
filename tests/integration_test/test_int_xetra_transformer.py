...
from src.transformer.transformer import XetraETL, XetraSourceConfig, XetraTargetConfig
...
class IntTestXetraETLMethods(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.s3_bucket_name_src = 'xetra-int-test-src-tie'
        self.s3_bucket_name_trg = 'xetra-int-test-trg-tie'
